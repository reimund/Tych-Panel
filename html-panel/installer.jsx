...
G = {
  ...
  /* INFO ======================================= */
  COMPANY: "",
  CONTACT_INFO: "reimund@code7.se",
  PRODUCT_NAME: "Tych Panel",
  PRODUCT_ID: "Tych Panel",
...
PSU = (function(GLOBAL) {
  ...
  createFolder = function(fptr) {
    ...
    rc = fptr.create();
    if (!rc) {
      Error.runtimeError(9002, "Unable to create folder (" + fptr.error + ")\nRun Photoshop as administrator and run this script again.");
    }
    return rc;
  };
...
try {
  ...
  alert(errorMessage + "\nPlease contact " + G.CONTACT_INFO + " if the error persists.");
}
